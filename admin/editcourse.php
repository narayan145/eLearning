...
if(isset($_REQUEST['requpdate'])){
    ...
    $msg='<div class="alert alert-warning col-sm-6 ml-5 mt-2">All Fields are Required...</div>';
        ...
        course_price='$cprice', course_original_price='$coriginalprice',
        course_img='$cimg' WHERE
        course_id='$cid'";
...
<div class="form-group">
        ...
        value="<?php if(isset($row['course_author'])){echo $row['course_author'];} ?>" name="course_author">
</div>

<div class="form-group">
        <label for="course_duration">Course Duration</label>
        <input type="text" class="form-control" id="course_duration" 
        value="<?php if(isset($row['course_duration'])){echo $row['course_duration'];} ?>" name="course_duration">
</div>
...
<div class="form-group">
        ...
        value="<?php if(isset($row['course_original_price'])){echo $row['course_original_price'];} ?>" name="course_original_price">
</div>
<div class="form-group">
        <label for="course_price">Course Selling Price</label>
        <input type="text" class="form-control" id="course_price"
        value="<?php if(isset($row['course_price'])){echo $row['course_price'];} ?>" name="course_price">
</div>
<div class="form-group">
