...
<div class="form-group">
        ...
        value="<?php if(isset($row['course_id'])){echo $row['course_id'];} ?>" name="course_id" readonly>
</div>

<div class="form-group">
        <label for="course_name">Course Name</label>
        <input type="text" class="form-control" id="course_name" onkeypress="isInputNumber(event)"
        value="<?php if(isset($row['course_name'])){echo $row['course_name'];} ?>" name="course_name" readonly>
</div>
